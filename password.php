...
<body>
                                    ...
                                    <div class="form-body">
                                        <form class="form-horizontal" action="myphp.php" method="post">
                                            <div class="form-group">
                                                <label for="inputPassword3" id="oldpassworderror"
                                            ...
                                            <div class="form-group">
                                                <label for="inputPassword3" id="newpassworderror"
                                            ...
                                            <div class="col-sm-offset-2">
                                                <input type="submit" class="btn btn-default" name="change_password"
                                                    id="change_password" value="Change Password">
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        $("#change_password").click(function() {
            ...
            var myurl = "myphp.php";
            var
                mydata = "oldpassword=" + oldpassword + "&newpassword=" + newpassword + "&cpassword=" +
                cp
            assword + "&change=yes";
            $.ajax({
                method: mymethod,
