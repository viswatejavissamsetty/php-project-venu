...
$result = select("SELECT * FROM cart INNER JOIN items ON cart.itemid = items.itemid WHERE userid='" . $_SESSION['userid'] . "'");
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.php">TRINETRA ONLINE
                            SUPERMARKET</a>
                ...
                <div class="card text-center">
                    ...
                    <div class="card-footer text-muted">
                        ...
                        while ($t = mysqli_fetch_array($result1)) {
                            extract($t);
                        ?>
                        <a href="index.php" class="btn btn-danger" style="font-weight:bold">Total
                            Price- <?= $t[0] ?> /-</a>
