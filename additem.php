                                ...
                                <div class="form-body">
                                    <form class="form-horizontal" action="myphp.php" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword3" id="errortitle"
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword3" placeholder="category" id="errortitle"
                                                class="col-sm-2 control-label">Category</label>
                                            <div class="col-xs-6">
                                                <select class="form-control" name="category">
                                                    <option>Select Category</option>
                                                    <option value="FruitVegetables">Fruits & Vegetables</option>
                                                    <option value="FoodgrainsoilMasala">Foodgrains, oil & Masala
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            <label for="inputPassword3" id="errormetakey"
                                                class="col-sm-2 control-label">Rating</label>
                                            <div class="col-xs-6">
                                                <input type="text" class="form-control" name="rating" min="1" max="5"
                                                    value="5" placeholder="Rating">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" id="image"
                                                class="col-sm-2 control-label">Image</label>
                                            <div class="col-xs-6">
                                                <input type="file" class="form-control col-xs-4" id="image"
                                                    name="image">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" id="video_link"
                                                class="col-sm-2 control-label">Price</label>
                                            <div class="col-xs-6">
                                                <input type="text" class="form-control col-xs-4" id="video_link"
                                                    name="price" placeholder="Price">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="inputEmail3" id="cpassworderror"
                                                class="col-sm-2 control-label">Discription</label>
                                            <div class="col-xs-6">
                                                <textarea name="discription" class="form-control col-xs-4"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <center><input type="submit" class="btn btn-info" name="elect_submit"
                                                    id="elec_submit" value="SUBMIT"></center>
                                        </div>
                                    </form>
                                </div>
                                </p>
