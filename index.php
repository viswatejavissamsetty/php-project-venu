            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.php">TRINETRA
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            ...
                            <div class="dorne-signin-btn">
                                ...
                                <a class="nav-link" href="mycart.php">My
                                    Cart</a>
                                ...
                                ?>
                                <a href="ragister.php">Sign in or
                                    Register</a>
                                <a class="nav-link" href="index.php">Home
                                    <span class="sr-only">(current)</span></a>
                                <a class="nav-link" href="category.php">Category</a>
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-6"></br></br>
                    <div class="hero-content"></br></br></br></br></br>
                        <h1 style="color:white;font-weight:bold; text-shadow: 2px 2px 14px #7546E4;">SEARCH YOUR PRODUCT
                        </h1>
                    </div>
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <button type="submit" name="onsearch" id="search_click"
                ...
                <div class="col-12">
                    <div class="features-slides owl-carousel">
                        ...
                        <div class="single-features-area">
                            <a href="view_detail.php?id=<?= $itemid ?>"><img src="admin/images/<?= $image ?>"
                ...
                <div class="col-12 d-md-flex align-items-center justify-content-between">
                    <div class="footer-text">
                        <p>
                            ...
                            </script> All rights reserved | This Project is made by
                            Team Trinetra</a>
                        </p>
                    </div>
                </div>
