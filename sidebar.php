<div class="sidebar-menu">
    ...
    <div class="menu">
        <ul id="menu">
            ...
            <li><a href="additem.php"><i class="fa fa-tachometer"></i> <span>Add New
                        Item</span></a></li>
            <li><a href="view_item_list.php"><i class="fa fa-tachometer"></i> <span>View
                        Item list</span></a></li>
            <li><a href="logout.php"><i class="fa fa-tachometer"></i>
                    <span>Logout</span></a></li>
            <?php } else { ?>
            <li><a href="login.php"><i class="fa fa-tachometer"></i>
