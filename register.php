                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="register-form" action="" method="post" role="form" style="display: none;">
                                ...
                                <div class="form-group">
                                    <input type="text" name="mobile" id="password" tabindex="2" class="form-control"
                                        placeholder="Mobile">
                                </div>
                                <div class="form-group">
                                    <input type="password" name="password" id="confirm-password" tabindex="2"
                                        class="form-control" placeholder="Password">
                                </div>
                                <div class="form-group">
                                    <div class="row">
                            ...
                            if (isset($_REQUEST['register'])) {
                                ...
                                $n = iud($query);
                                if ($n == 1) {
                                    echo "<script>alert('Register successfull');window.location='ragister.php';</script>";
                                } else {
                                    echo "<script>alert('Something Wrong');window.location='ragister.php';</script>";
                                }
                            }
