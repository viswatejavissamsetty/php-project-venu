...
FROM cart
INNER JOIN items ON cart.itemid = items.itemid WHERE
...
<body>
    ...
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: 
url(img/bg-img/hero-1.jpg)"></div>
    </br>
    <div class="container-fluid">
        <div class="row">
            ...
            <br>
            <div class="container">
                <a href="mycart.php"><button class="btn btn-warning"><span
